...
public abstract class CraftOldEnumRegistryItem<T extends OldEnum<T>, M> extends CraftRegistryItem<M> implements OldEnum<T> {
    ...
    private void checkState() {
        Preconditions.checkState(isRegistered(), "Cannot call method for this registry item, because it is not registered. Use #isRegistred() before calling this method.");
    }
}
