...
class CraftMetaItem implements ItemMeta, Damageable, Repairable, BlockDataMeta {
    ...
    boolean applicableTo(ItemType type) {
        ...
        return type.getItemMetaClass() == getClass().getInterfaces()[0];
    }
    ...
    @Override
    public <B extends BlockData> B getBlockData(BlockType.Typed<B> blockType) {
        IBlockData defaultData = CraftBlockType.bukkitToMinecraft(blockType).defaultBlockState();
        return (B) CraftBlockData.fromData((hasBlockData()) ? new BlockItemStateProperties(blockData).apply(defaultData) : defaultData);
    }
