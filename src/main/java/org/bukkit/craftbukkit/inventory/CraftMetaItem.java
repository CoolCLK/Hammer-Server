...
class CraftMetaItem implements ItemMeta, Damageable, Repairable, BlockDataMeta {
    ...
    protected class CraftComponents implements ItemMeta.Components {
        ...
        @Override
        public BaseComponent getItemName() {
            return CraftChatMessage.toBungeeOrEmpty(itemName);
        }

        @Override
        public void setItemName(BaseComponent itemName) {
            CraftMetaItem.this.itemName = CraftChatMessage.fromBungeeOrNull(itemName);
        }
