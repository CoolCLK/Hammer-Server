...
public class CraftLivingEntity extends CraftEntity implements LivingEntity {
    ...
    public void setAbsorptionAmount(double amount) {
        amount = (float) amount;
        Preconditions.checkArgument(amount >= 0 && amount <= getHandle().getMaxAbsorption(), "Absorption value (%s) must be between 0 and %s. Use Attribute `generic.max_absorption` to increase the limit.", amount, getHandle().getMaxAbsorption());
